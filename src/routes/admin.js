 ...
 */
// Getting all Article
adminRoute.get("/v1/admin/blog_articles", adminController.allArticles);

/**
 * @swagger
 * /v1/admin/blog_articles/{id}:
 *   get:
...
// Getting all Message
adminRoute.get("/v1/admin/messages", verifyAccessToken, adminController.allMessages);
...
adminRoute.post("/v1/admin/messages", adminController.createMessage);
